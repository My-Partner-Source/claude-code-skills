#!/bin/bash
# Setup script for redis-access skill
...
echo "Setting up redis-access skill..."
...
SCRIPT_PATH="$SCRIPT_DIR/scripts/redis_access.py"
...
echo ""
echo "Usage:"
echo "  $SCRIPT_DIR/scripts/redis_access.py --env DEV get mykey"
echo ""
